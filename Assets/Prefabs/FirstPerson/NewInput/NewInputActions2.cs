// GENERATED AUTOMATICALLY FROM 'Assets/Prefabs/FirstPerson/NewInput/NewInputActions2.inputactions'

[System.Serializable]
public class NewInputActions2 : UnityEngine.Experimental.Input.InputActionWrapper
{
    ...
    private void Initialize()
    {
        ...
        m_gameplay_gamePadLook = m_gameplay.GetAction("gamePadLook");
        m_Initialized = true;
    }
    // gameplay
    ...
    private UnityEngine.Experimental.Input.InputAction m_gameplay_gamePadLook;
    public struct GameplayActions
    {
        private NewInputActions2 m_Wrapper;
        public GameplayActions(NewInputActions2 wrapper) { m_Wrapper = wrapper; }
        ...
        public UnityEngine.Experimental.Input.InputAction @gamePadLook { get { return m_Wrapper.m_gameplay_gamePadLook; } }
